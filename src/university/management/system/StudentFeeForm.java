...
public class StudentFeeForm extends JFrame implements ActionListener{
    ...
    StudentFeeForm(){
        ...
        JLabel lblrollnunber = new JLabel("Select Roll No");
        lblrollnunber.setBounds(40,60,150,20);
        lblrollnunber.setFont(new Font("Tahoma",Font.BOLD,16));
        add(lblrollnunber);
        ...
        String course[] = {"BTech","MTech","BCA","BSc","MSc","MCA","Bcom","Mcom"};
